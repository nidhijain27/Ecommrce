...
const Create = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${baseUrl}/products/createProduct`, {
        method: "POST",
        headers: {
  ...
  const imageUpload = async () => {
    ...
    data.append("upload_preset", "nj-store");
    data.append("cloud_name", "dpcvoalz0");
    const res = await fetch(
      "	https://api.cloudinary.com/v1_1/dpcvoalz0/image/upload",
      {
        method: "POST",
        body: data,
      }
